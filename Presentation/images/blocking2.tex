...
\draw[decorate, decoration={brace}, xshift=-4ex]  (0,0) -- node[left=0.4ex] {$m$}  (0,8);
...
\draw (12,5.5) node {$w_{np}^{(1)}$};
\draw (12,4.5) node {$w_{np}^{(2)}$};
\draw (12,3.5) node {$\vdots$};
\draw (12,2.5) node {$w_{np}^{(nbs)}$};

%% Pfeile
\draw [arrow, bend angle=30, bend left]  (2,7) to (5,6);
\draw [arrow, bend angle=40, bend left]  (2,5) to (8,6);

\draw [arrow, bend angle=45, bend left]  (2,1) to (12,6);
